...
$(document).ready(function () {
  var form = $('#article__upsert');

  if (form.length == 0) {
    return;
  }

  var title = form.find('input[name="article__title"]');
  var text = form.find('textarea[name="article__text"]');
  var categories = form.find('select[name="article__categories"]');
  ...
  form.submit(function () {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        submitButton.notify('successful', {
          className: 'success',
          position: 'right'
        });
      },
...
/* harmony import */ var _vendor_notify_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/notify.min */ "./resources/js/vendor/notify.min.js");
/* harmony import */ var _vendor_notify_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_notify_min__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _articles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./articles */ "./resources/js/articles.js");
/* harmony import */ var _articles__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_articles__WEBPACK_IMPORTED_MODULE_3__);
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
/***/ "./resources/js/vendor/notify.min.js":
/*!*******************************************!*\
  !*** ./resources/js/vendor/notify.min.js ***!
  \*******************************************/
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/style"], () => (__webpack_require__("./resources/css/main.scss")))
